...
@Test(groups = {"simplePngGenerationTest"})
public class SimplePngGenerationTest {
    private static final String OUTPUT_FOLDER = System.getProperty("java.io.tmpdir") + File.separator + "PngTests";
    ...
    public void createImage() throws IOException, TranscoderException {
        ...
        OutputStream outputStream = new FileOutputStream(OUTPUT_FOLDER
                + File.separator + "documentResource.png");
    ...
    public void documentBackgroundColorTest() throws IOException {
        ...
        Files.write(Paths.get(OUTPUT_FOLDER
                + File.separator + "documentBackgroundColor.png"), PngGenerator.generate(svgTemplate));
    }
    ...
    public void documentBackgroundImageTest() throws IOException {
        ...
        Files.write(Paths.get(OUTPUT_FOLDER
                + File.separator + "documentBackgroundImage.png"), PngGenerator.generate(svgTemplate));
    }
    ...
    public void documentDrawCircleTest() throws IOException {
        ...
        Files.write(Paths.get(OUTPUT_FOLDER
                + File.separator + "documentDrawCircle.png"), PngGenerator.generate(svgTemplate));
    }
    ...
    public void documentImageTest() throws IOException {
        ...
        Files.write(Paths.get(OUTPUT_FOLDER
                + File.separator + "documentImage.png"), PngGenerator.generate(svgTemplate));
    }
