...
public class BoardingPassCollaborationChallengeFromDroolsTest extends AbstractTestNGSpringContextTests {
    ...
    private static final String BAD_URL = "https://www.yahoo.com";
    private static final String GOOD_URL = "https://www.google.com/search?q=";
    ...
    private List<SvgAreaElement> generateSubmitButton() {
        ...
        button.setXRadius(9);
        button.setYRadius(9);
        button.setLink(BUTTON_URL + BUTTON_USER);
        ...
        buttonLabel.setLink(BUTTON_URL + BUTTON_USER);
