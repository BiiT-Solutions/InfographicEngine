...
public class BoardingPassCollaborationChallengeFromDroolsTest extends AbstractTestNGSpringContextTests {
    ...
    private static final String SECOND_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*0.25" + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + ValueCalculator.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
    private static final String THIRD_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*0.5" + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + ValueCalculator.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
    private static final String FORTH_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*0.75" + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + ValueCalculator.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
    private static final String FIFTH_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME" + ValueCalculator.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + ValueCalculator.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
