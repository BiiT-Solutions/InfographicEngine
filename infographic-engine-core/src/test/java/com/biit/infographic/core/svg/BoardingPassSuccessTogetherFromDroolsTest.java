...
public class BoardingPassSuccessTogetherFromDroolsTest extends AbstractTestNGSpringContextTests {
    ...
    private static final String TEMPLATE_NAME = "boardingPassSuccessTogetherTemplate";
    ...
    private static final String SECOND_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*0.30" + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + AppointmentContent.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
    private static final String THIRD_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*0.60" + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + AppointmentContent.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
    private static final String FORTH_CIRCLE_COLOR = "#APPOINTMENT%TEMPLATE%" + TEMPLATE_NAME + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + "DURATION_TIME*1" + AppointmentContent.ATTRIBUTE_FIELDS_SEPARATION + TEMPLATE_DISABLED_COLOR + AppointmentContent.CONDITION_SEPARATION + TEMPLATE_ENABLED_COLOR + "#";
