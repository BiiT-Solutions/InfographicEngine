 ...
 */
public class SvgGeneratorLogger extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(SvgGeneratorLogger.class);
