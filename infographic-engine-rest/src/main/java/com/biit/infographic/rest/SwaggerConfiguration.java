...
public class SwaggerConfiguration extends DefaultSwaggerConfiguration {
    private static final String SWAGGER_TITLE = "Infographic Engine v2";
    private static final String SWAGGER_DESCRIPTION = "";
    private static final String SWAGGER_GROUP = "rest-public";

    private static final String[] PACKAGES_TO_SCAN = new String[]{"com.biit.infographic.rest", "com.biit.server.rest", "com.biit.server.security.rest"};
