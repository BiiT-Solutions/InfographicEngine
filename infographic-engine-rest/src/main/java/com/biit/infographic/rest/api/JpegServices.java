...
public class JpegServices extends ImageServices {
    ...
    public JpegServices(SecurityService securityService, GeneratedInfographicController generatedInfographicController, ZipController zipController) {
    ...
    public byte[] getLatest(
        ...
        if (page >= generatedInfographicAsJpegDTO.getJpegContents().size()) {
            throw new NotFoundException(this.getClass(), "No page '" + page + "' exists. Maximum available pages are "
                    + generatedInfographicAsJpegDTO.getJpegContents().size() + ".");
        }

        return generatedInfographicAsJpegDTO.getJpegContents().get(page);
    }
    ...
    public byte[] getLatestAsZip(
        ...
        int page = 1;
        for (byte[] image : generatedInfographicAsJpegDTO.getJpegContents()) {
