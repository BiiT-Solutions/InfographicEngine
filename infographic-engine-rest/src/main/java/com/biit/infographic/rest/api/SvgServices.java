...
//        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, contentDisposition.toString());
    ...
    @Operation(summary = "Not Working!!! Search results as PNG generated by drools.", description = """
    ...
    public byte[] getLatestAsZip(
        ...
        return pdfController.generatePdfFromSvg(generatedInfographic.get().getSvgContents());
